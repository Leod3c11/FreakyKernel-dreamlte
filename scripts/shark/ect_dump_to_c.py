#!/usr/bin/env python3
"""Generate the Shark Exynos8895 static ECT catalog from debugfs all_dump."""
...
def emit_catalog(out, tables, digest):
    print("/* SPDX-License-Identifier: GPL-2.0 */", file=out)
    print("/* Generated by scripts/shark/ect_dump_to_c.py; do not edit. */", file=out)
    print("#ifndef __EXYNOS8895_SHARK_DATA_H__", file=out)
    print("#define __EXYNOS8895_SHARK_DATA_H__\n", file=out)
    ...
    print("#endif /* __EXYNOS8895_SHARK_DATA_H__ */", file=out)
