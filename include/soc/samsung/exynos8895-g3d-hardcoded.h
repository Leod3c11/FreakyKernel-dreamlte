 ...
 * The non-zero values at 260..550 MHz below come from this device's
 * observed stock ASV table (ECT table version 8 / ASV group 4 anchors).
 * 600 MHz and above intentionally stay at 0 until their rail voltage is
 * explicitly chosen/validated.
...
static const struct exynos8895_g3d_hardcoded_opp exynos8895_g3d_opp_table[] = {
    ...
    { 550000, 550, 13, 1,     572000,     681250, 47, 65, 1, 2093000,       0, 0 },
    { 500000, 500, 13, 1,     546000,     662500, 40, 65, 1, 2002000,       0, 0 },
    { 450000, 450, 13, 1,     455000,     650000, 40, 65, 1, 2002000,       0, 0 },
    { 400000, 400, 13, 1,     455000,     650000, 42, 65, 1, 1794000,       0, 0 },
    { 350000, 350, 13, 1,     385000,     643750, 42, 65, 1, 1794000,       0, 0 },
    { 300000, 300, 13, 1,     338000,     637500, 35, 65, 1, 1352000,       0, 0 },
    { 260000, 520, 13, 2,     260000,     637500, 35, 65, 1, 1352000,       0, 0 },
};
